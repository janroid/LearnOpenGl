...
int main()
{
	...
	Shader_m ourShader("D:/VSWorkspace/GLTest/shader/VerShaderSource.shader","D:/VSWorkspace/GLTest/shader/FrameShaderSource.shader");
	...
	std::string filePath = "D:/VSWorkspace/GLTest/res/container.jpg";
	unsigned char *data = stbi_load(filePath.c_str(), &width, &height, &nrChannels, 0);
	if (data) {
		if (nrChannels == 3)// rgb,适用于jpg
		{
			glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGB, GL_UNSIGNED_BYTE, data);
		}
		else if (nrChannels == 4)// rgba,适用于png
		{
	...
	std::string pngPath = "D:/VSWorkspace/GLTest/res/awesomeface.png";
	data = stbi_load(pngPath.c_str(), &width, &height, &nrChannels, 0);
	if (data) {
		if (nrChannels == 3)// rgb,适用于jpg
		{
			glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGB, GL_UNSIGNED_BYTE, data);
