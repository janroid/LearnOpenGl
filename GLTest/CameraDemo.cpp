...
public:
	...
	void init(GLFWwindow* window) {
		...
		mshader = Shader_m("D:/VSWorkspace/LearnGL/shader/CameraVerShader.shader", "D:/VSWorkspace/LearnGL/shader/CameraFrameShader.shader");
		...
		mshader.setInt("aTexture1", 0);
		mshader.setInt("aTexture2", 1);	
